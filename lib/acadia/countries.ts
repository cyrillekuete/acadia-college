...
export const COUNTRIES: CountryOption[] = [
  ...
  { code: 'AS', name: 'American Samoa', flag: '/media/flags/american-samoa.svg' },
  ...
  { code: 'AG', name: 'Antigua and Barbuda', flag: '/media/flags/antigua-and-barbuda.svg' },
  ...
  { code: 'BA', name: 'Bosnia and Herzegovina', flag: '/media/flags/bosnia-and-herzegovina.svg' },
  { code: 'BW', name: 'Botswana', flag: '/media/flags/botswana.svg' },
  { code: 'BR', name: 'Brazil', flag: '/media/flags/brazil.svg' },
  { code: 'IO', name: 'British Indian Ocean Territory', flag: '/media/flags/british-indian-ocean-territory.svg' },
  ...
  { code: 'KY', name: 'Cayman Islands', flag: '/media/flags/cayman-islands.svg' },
  { code: 'CF', name: 'Central African Republic', flag: '/media/flags/central-african-republic.svg' },
  ...
  { code: 'CG', name: 'Congo', flag: '/media/flags/republic-of-the-congo.svg' },
  { code: 'CR', name: 'Costa Rica', flag: '/media/flags/costa-rica.svg' },
  { code: 'CI', name: "Cote D'Ivoire", flag: '/media/flags/ivory-coast.svg' },
  { code: 'HR', name: 'Croatia', flag: '/media/flags/croatia.svg' },
  { code: 'CU', name: 'Cuba', flag: '/media/flags/cuba.svg' },
  { code: 'CY', name: 'Cyprus', flag: '/media/flags/flag.svg' },
  { code: 'CZ', name: 'Czech Republic', flag: '/media/flags/czech-republic.svg' },
  ...
  { code: 'DO', name: 'Dominican Republic', flag: '/media/flags/dominican-republic.svg' },
  ...
  { code: 'GQ', name: 'Equatorial Guinea', flag: '/media/flags/equatorial-guinea.svg' },
  { code: 'ER', name: 'Eritrea', flag: '/media/flags/eritrea.svg' },
  { code: 'EE', name: 'Estonia', flag: '/media/flags/estonia.svg' },
  { code: 'SZ', name: 'Eswatini', flag: '/media/flags/swaziland.svg' },
  ...
  { code: 'GY', name: 'Guyana', flag: '/media/flags/flag.svg' },
  ...
  { code: 'MH', name: 'Marshall Islands', flag: '/media/flags/marshall-island.svg' },
  ...
  { code: 'PG', name: 'Papua New Guinea', flag: '/media/flags/papua-new-guinea.svg' },
  ...
  { code: 'AE', name: 'United Arab Emirates', flag: '/media/flags/united-arab-emirates.svg' },
  { code: 'GB', name: 'United Kingdom', flag: '/media/flags/united-kingdom.svg' },
...
export const DEFAULT_COUNTRY_NAME = 'Cameroon';

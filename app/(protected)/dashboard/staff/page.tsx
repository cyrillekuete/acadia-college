...
import { Book, CalendarCheck, ScrollText } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="grid gap-5 md:grid-cols-3">
        ...
        <DashboardStatCard title="Today's sessions" value="—" icon={CalendarCheck} />
        <DashboardStatCard title="Pending marks" value="—" icon={ScrollText} />
      </div>
      <Card className="mt-5">

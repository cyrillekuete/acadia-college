...
CREATE TYPE "ExamSessionType" AS ENUM ('NORMAL', 'RESIT', 'GCE', 'BEPC', 'PROBATOIRE', 'BACCALAUREAT');
CREATE TYPE "FeeInstallmentStatus" AS ENUM ('PENDING', 'PAID', 'OVERDUE', 'WAIVED');
CREATE TYPE "GradingMode" AS ENUM ('FRANCOPHONE', 'ANGLOPHONE', 'PER_STREAM');
CREATE TYPE "MarkEntryCalendarPolicy" AS ENUM ('SESSION_DATES_ONLY', 'CALENDAR_AND_SESSION');
CREATE TYPE "MessageGroupScope" AS ENUM ('DEPARTMENT', 'STREAM', 'LEVEL');

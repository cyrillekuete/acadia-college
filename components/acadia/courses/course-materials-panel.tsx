...
export function CourseMaterialsPanel({
  ...
  const { createMaterial, deleteMaterial } = useCourseMutations();
  ...
  const { data: materials = [], isLoading } = useQuery({
    queryKey: ['course-materials', tenantId, courseId],
    queryFn: async () => {
  ...
  const form = useForm<CourseMaterialFormValues>({
  ...
  const onSubmit = (values: CourseMaterialFormValues) => {

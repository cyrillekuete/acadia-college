...
import {
  ATTENDANCE_SESSION_FORM_ID,
  AttendanceSessionForm,
} from '@/components/acadia/attendance/attendance-session-form';
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="p-0 gap-0 sm:w-[500px] sm:max-w-none inset-5 start-auto h-auto rounded-lg p-0 sm:max-w-none [&_[data-slot=sheet-close]]:top-4.5 [&_[data-slot=sheet-close]]:end-5">
        <SheetHeader className="mb-0">
          <SheetTitle className="p-3">{t('attendance.newSession')}</SheetTitle>
        </SheetHeader>
        ...
        <SheetFooter className="border-t border-border p-5">
          ...
          <Button type="submit" form={ATTENDANCE_SESSION_FORM_ID} disabled={pending}>
